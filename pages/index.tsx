...
import { SignedPayload721WithQuantitySignature } from "@web3sdks/sdk";
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.describe}>
        ...
        <a href="https://opensea.io/collection/web3sdks-community">
          Early Access NFTs
        </a>{" "}
        can mint for free using the{" "}
        <a href="https://docs.web3sdks.com/pre-built-contracts/signature-drop#signature-minting">
          Signature Mint
        </a>
